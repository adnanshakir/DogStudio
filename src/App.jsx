...
const App = () => {
  return (
    <main className="relative text-white bg-[#15161b]">
      ...
      <section id="section-1" className="min-h-screen relative z-10">
        <nav className="w-full px-12 py-14 flex items-center justify-between ">
          <svg
            className="w-28"
            fill="white"
          ...
          <span>
            <i className="ri-arrow-right-s-line text-lg font-bold text-red-600"></i>{" "}
            Our Showreel
          </span>
          <i className="ri-menu-3-line text-2xl"></i>
        </nav>
        <div className="flex w-full">
          <div className="w-1/2 right text-9xl pt-8 leading-28 tracking-wide font-bold flex items-center justify-end text-end">
            <h1>
              We <br />
        ...
        <div className="w-full flex">
          ...
          <div className="w-1/2">
            <div className="w-2/3">
              <p className="font-thin pt-30 pl-32 text-2xl">
